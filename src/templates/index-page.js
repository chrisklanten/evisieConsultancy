    ...
    <div>
      <section className="flex flex-col sm:flex-row items-stretch relative">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${!!intro.mainImage.childImageSharp
          ...
          <Img
            ...
            fluid={
              !!intro.mainImage.childImageSharp
                ? intro.mainImage.childImageSharp.fluid
                : intro.mainImage
            }
          />
      ...
      <section className="bg-evisie-gray py-10">
        <div className="container text-center">
          <h2 id="diensten">{services.title}</h2>
      ...
      <section className="flex flex-col sm:flex-row items-stretch relative">
        <div
          className="w-full sm:min-h-0 relative"
          style={{
            backgroundImage: `url(${!!about.aboutImage.childImageSharp
        ...
        <div className="w-full">
          <div className="p-6 ml-12 py-10 sm:py-20 max-w-lg mr-12">
            <h1 className=" max-w-sm" id="over-evisie">{about.title}</h1>
      ...
      <section className="bg-evisie-yellow py-8 sm:p-16 text-center pb-16 sm:pb-24">
        ...
        <div className="block sm:flex justify-center items-stretch px-4 sm:px-0">

          {reviews.reviews.map((review, i) => (
              <div
                key={i}
                className="rounded-sm review w-full bg-white flex flex-col justify-center items-center p-8 mb-4 sm:mr-4"
              >
                <img
                  src={
          ...
          >
            {reviews.reviews.map((review, i) => (
              <SwiperSlide
                key={i}
                className="swiper-slide rounded-sm review bg-white flex flex-col self-center justify-center items-center p-8"
              >
                <img
                  src={
                    !!review.logo.childImageSharp
